...
allo.pair <- pairwise(cross.males.fullMod, cross.males.alloNull, groups = gdf.cross.males$line, covariate = gdf.cross.males$logCS)
...
#actually want to bootstrap these. Accounting 
cor.mod_test <- lm(as.matrix(all.male[,1:30]) ~ logCS_c*line,
                   data = all.male)

coef(cor.mod_test)

ef43_vec <- cor.mod_test$coef[2,]
ef81_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[11,]
ef96_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[12,]
zi192_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[13,]
zi192ef43_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[14,]
zi192ef81_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[15,]
zi192ef96_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[16,]
zi251_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[17,]
zi418_vec <- cor.mod_test$coef[2,] + cor.mod_test$coef[18,]



VecCorBoot_alloAll <- function(data, indices, vars = 1:30) {
  d <- data[indices,] # allows boot to select sample
  cor.mod1 <- lm(as.matrix(d[,vars]) ~ logCS_c*line ,
                 data = d)
  ef43 <- cor.mod1$coef[2,]
  ef81 <- cor.mod1$coef[2,] + cor.mod1$coef[11,]
  ef96 <- cor.mod1$coef[2,] + cor.mod1$coef[12,]
  zi192 <- cor.mod1$coef[2,] + cor.mod1$coef[13,]
  zi192ef43 <- cor.mod1$coef[2,] + cor.mod_test$coef[14,]
  zi192ef81 <- cor.mod1$coef[2,] + cor.mod_test$coef[15,]
  zi192ef96 <- cor.mod1$coef[2,] + cor.mod_test$coef[16,]
  zi251 <- cor.mod1$coef[2,] + cor.mod_test$coef[17,]
  zi418 <- cor.mod1$coef[2,] + cor.mod_test$coef[18,]

  cor43.81 <- cor(ef43, ef81)
  cor43.96 <- cor(ef43, ef96)
  cor43.192 <- cor(ef43, zi192)
  cor43.19243 <- cor(ef43, zi192ef43)
  cor43.19281 <- cor(ef43, zi192ef81)
  cor43.19296 <- cor(ef43, zi192ef96)
  cor43.251 <- cor(ef43, zi251)
  cor43.418 <- cor(ef43, zi418)
  cor81.96 <- cor(ef81, ef96)
  cor81.192 <- cor(ef81, zi192)
  cor81.19243 <- cor(ef81, zi192ef43)
  cor81.19281 <- cor(ef81, zi192ef81)
  cor81.19296 <- cor(ef81, zi192ef96)
  cor81.251 <- cor(ef81, zi251)
  cor81.418 <- cor(ef81, zi418)
  cor96.192 <- cor(ef96, zi192)
  cor96.19243 <- cor(ef96, zi192ef43)
  cor96.19281 <- cor(ef96, zi192ef81)
  cor96.19296 <- cor(ef96, zi192ef96)
  cor96.251 <- cor(ef96, zi251)
  cor96.418 <- cor(ef96, zi418)
  cor192.19243 <- cor(zi192, zi192ef43)
  cor192.19281 <- cor(zi192, zi192ef81)
  cor192.19296 <- cor(zi192, zi192ef96)
  cor192.251 <- cor(zi192, zi251)
  cor192.418 <- cor(zi192, zi418)
  cor19243.19281 <- cor(zi192ef43, zi192ef81)
  cor19243.19296 <- cor(zi192ef43, zi192ef96)
  cor19243.251 <- cor(zi192ef43, zi251)
  cor19243.418 <- cor(zi192ef43, zi418)
  cor19281.19296 <- cor(zi192ef81, zi192ef96)
  cor19281.251 <- cor(zi192ef81, zi251)
  cor19281.418 <- cor(zi192ef81, zi418)
  cor19296.251 <- cor(zi192ef96, zi251)
  cor19296.418 <- cor(zi192ef96, zi418)
  cor251.418 <- cor(zi251, zi418)
  
  
  return(c(cor43.81, cor43.96, cor43.192, cor43.19243, cor43.19281, 
           cor43.19296, cor43.251, cor43.418, cor81.96, cor81.192, 
           cor81.19243, cor81.19281, cor81.19296, cor81.251, cor81.418,
           cor96.192, cor96.19243, cor96.19281, cor96.19296, cor96.251, 
           cor96.418, cor192.19243, cor192.19281, cor192.19296, cor192.251, 
           cor192.418, cor19243.19281, cor19243.19296, cor19243.251, 
           cor19243.418, cor19281.19296, cor19281.251, cor19281.418, 
           cor19296.251, cor19296.418, cor251.418))
}

VecCorBoot_alloAll (all.male)

VecBoot_alloAll_results <- boot(data = all.male,
                        statistic = VecCorBoot_alloAll, R = 2000,
                        strata = as.factor(all.male$line))

vec.boot_allo.mat <- data.frame(VecBoot_alloAll_results[["t"]])

#making this so I can double check my comparisons 
check.index <- c("cor43.81", "cor43.96", "cor43.192", "cor43.19243", 
                 "cor43.19281", "cor43.19296", "cor43.251", "cor43.418",
                 "cor81.96", "cor81.192", "cor81.19243", "cor81.19281", 
                 "cor81.19296", "cor81.251", "cor81.418","cor96.192", 
                 "cor96.19243", "cor96.19281", "cor96.19296", "cor96.251", 
                 "cor96.418", "cor192.19243", "cor192.19281", "cor192.19296",
                 "cor192.251", "cor192.418", "cor19243.19281", 
                 "cor19243.19296", "cor19243.251", "cor19243.418", 
                 "cor19281.19296", "cor19281.251", "cor19281.418", 
                 "cor19296.251", "cor19296.418", "cor251.418")

#getting observation and bootstrap
cor(ef43_vec, ef81_vec)
quantile(vec.boot_allo.mat[,1], probs= c(0.05, 0.95))

cor(ef43_vec, ef96_vec)
quantile(vec.boot_allo.mat[,2], probs= c(0.05, 0.95))

cor(ef43_vec, zi192_vec)
quantile(vec.boot_allo.mat[,3], probs= c(0.05, 0.95))

cor(ef43_vec, zi192ef43_vec)
quantile(vec.boot_allo.mat[,4], probs= c(0.05, 0.95))

cor(ef43_vec, zi192ef81_vec)
quantile(vec.boot_allo.mat[,5], probs= c(0.05, 0.95))

cor(ef43_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,6], probs= c(0.05, 0.95))

cor(ef81_vec, ef96_vec)
quantile(vec.boot_allo.mat[,9], probs= c(0.05, 0.95))

cor(ef81_vec, zi192ef43_vec)
quantile(vec.boot_allo.mat[,11], probs= c(0.05, 0.95))

cor(ef81_vec, zi192ef81_vec)
quantile(vec.boot_allo.mat[,12], probs= c(0.05, 0.95))

cor(ef81_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,13], probs= c(0.05, 0.95))

cor(ef96_vec, zi192_vec)
quantile(vec.boot_allo.mat[,16], probs= c(0.05, 0.95))

cor(ef96_vec, zi192ef43_vec)
quantile(vec.boot_allo.mat[,17], probs= c(0.05, 0.95))

cor(ef96_vec, zi192ef81_vec)
quantile(vec.boot_allo.mat[,18], probs= c(0.05, 0.95))

cor(ef96_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,19], probs= c(0.05, 0.95))

cor(zi192_vec, zi192ef43_vec)
quantile(vec.boot_allo.mat[,22], probs= c(0.05, 0.95))

cor(zi192_vec, zi192ef81_vec)
quantile(vec.boot_allo.mat[,23], probs= c(0.05, 0.95))

cor(zi192_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,24], probs= c(0.05, 0.95))

cor(zi192ef43_vec, zi192ef81_vec)
quantile(vec.boot_allo.mat[,27], probs= c(0.05, 0.95))

cor(zi192ef43_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,28], probs= c(0.05, 0.95))

cor(zi192ef81_vec, zi192ef96_vec)
quantile(vec.boot_allo.mat[,31], probs= c(0.05, 0.95))
