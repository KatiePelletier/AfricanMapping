...
####
syncX <- read.sync(file="../Data/allSizeCoreGenome_X.sync", 
                  gen=gen, repl=reps, 
                  polarization = "minor", 
...
write.csv(afdatX, "../Data/allSizeMales_cmh_acer_X.csv")

rm(list=ls(pattern="X"))
#####################


sync2L <- read.sync(file="../Data/allSizeCoreGenome_2L.sync", 
                    gen=gen, repl=reps, 
                    polarization = "minor", 
                    keepOnlyBiallelic = TRUE)
...
write.csv(afdat2L, "../Data/allSizeMales_cmh_acer_2L.csv")
...
sync2R <- read.sync(file="../Data/allSizeCoreGenome_2R.sync", 
                    gen=gen, repl=reps, 
                    polarization = "minor", 
                    keepOnlyBiallelic = TRUE)
...
write.csv(afdat2R, "../Data/allSizeMales_cmh_acer_2R.csv")
...
sync3L <- read.sync(file="../Data/allSizeCoreGenome_3L.sync", 
                    gen=gen, repl=reps, 
                    polarization = "minor", 
                    keepOnlyBiallelic = TRUE)
...
write.csv(afdat3L, "../Data/allSizeMales_cmh_acer_3L.csv")
...
sync3R <- read.sync(file="../Data/allSizeCoreGenome_3R.sync", 
                    gen=gen, repl=reps, 
                    polarization = "minor", 
                    keepOnlyBiallelic = TRUE)
...
write.csv(afdat3R, "../Data/allSizeMales_cmh_acer_3R.csv")

rm(list=ls(pattern="3R"))

##################
sync4 <- read.sync(file="../Data/allSizeCoreGenome_4.sync", 
                   gen=gen, repl=reps, 
                   polarization = "minor", 
                   keepOnlyBiallelic = TRUE)
...
write.csv(afdat4, "../Data/allSizeMales_cmh_acer_4.csv")
